...
void test_validate_my_username()
{
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(username, file_username, "The username in conf/username.txt does not match the hardcoded username in autotest-validate.c");
}
